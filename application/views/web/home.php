...
<html lang="en">
  <head>
    <title>MTS AL-JIHADIYAH</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    
    <link rel="icon" type="image/png" href="<?php echo base_url(); ?>images/logo smk/">
  ...
  <body>
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
			    		<div class="col-md-5 pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">JL.Madrasah Pesanggrahan Bintaro</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-secondary mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">MTSAlJihadiyah@gmail.com</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco_navbar ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	    	<a class="navbar-brand" href="#">MTS AL-JIHADIYAH</a>
          ...
          <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-primary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>MTS Al-Jihadiyah memilik guru-guru berkualitas dalam hal belajar mengajar</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-tertiary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>MTS Al-Jihadiyah adalah sekolah yang telah ter-Akretedasi A dan diakui oleh Pemerintah dan Kemendikbud.</p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-fifth">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>MTS Al-Jihadiyah memiliki 6 Jurusan yaitu: RPL, TKJ, TKR, APAT, JSB, &amp; NKPI. dan semua sudah diakui kualitasnya.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-quarternary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>MTS Al-Jihadiyah terletak di lokasi yang strategis, yaitu berada di Jalan Soekarno-Hatta No.70 Brangsong, Kendal.</p>
              </div>
            </div>      
          </div>
        </div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 wrap-about py-5 pr-md-4 ftco-animate">
          				<h2 class="mb-4">Tentang MTS AL-JIHADIYAH </h2>
						<p>MTS Al-Jihadiyah  merupakan salah satu sekolah kejuruan di daerah Kabupaten Kendal yang didirikan pada tahun 2005. Sekolah yang berlokasi di Brangsong Kendal ini memiliki 6 Kejurusan yaitu: RPL, TKJ, TKR, JSB, APAT, &amp; NKPI.</p>
						<div class="row mt-5">
							<div class="col-lg-6">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-5">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">JL.Madrasah Pesanggrahan Bintaro</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+62</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">MTSAlJihadiyah@yahoo.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
